...
public:
    ...
    real_t &at(int idx, int idx2) ;
    real_t at(int idx1, int idx2) const ;
...
protected:
    real_t *get_page_data(unsigned int page_no);
...
public:
    ...
    void get_page(unsigned int page_no, Tensor_2D<Index1, Index2> &);
};
